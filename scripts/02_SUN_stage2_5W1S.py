...
opt.save_path = './experiments/sun_stage2_5W1S'
opt.embnet_pretrainedandfix = True
opt.pretrain_embnet_path = './experiments/sun_stage1/best_model.pth'
opt.gpu=gpu_id
...
opt.load = './experiments/sun_stage2_5W1S/best_model.pth'
opt.gpu=gpu_id
opt.network = 'ResNet12'
opt.head = 'CPN'
opt.proto_fusion = 'CPN'

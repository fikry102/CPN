...
def conv4(in_planes=3, userelu=False, num_stages=4):
    """Constructs a Conv4 model.
    """
    opt = {'userelu': userelu, 'in_planes':in_planes, 'out_planes':[64,64,64,64], 'num_stages':num_stages}
    model = ConvNet(opt)
    return model
...
class CUB(data.Dataset):
    def __init__(self, phase='train', do_not_use_random_transf=False):
        ...
        if self.phase=='train':
            ...
            self.label2ind = buildLabelIndex(self.labels)#class_id:[...,...,...]
...
class FewShotDataloader():
    ...
    def sample_base_and_novel_categories(self, nKbase, nKnovel):
        ...
        Returns:
            ...
            Knovel: a list of lenght 'nKnovel' with the ids of the sampled novel
                categories.
        """
        if self.is_eval_mode:#(self.phase=='test') or (self.phase=='val')
    ...
    def createExamplesTensorData(self, examples):
        ...
        #     [self.dataset[img_idx][1] for img_idx, _ in examples])
    ...
    def get_iterator(self, epoch=0):
        ...
        #self.epoch_size=opt.epoch_size*opt.episodes_per_batch
        ...
        #self.batch_size=opt.episodes_per_batch
        return data_loader

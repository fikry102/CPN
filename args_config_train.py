...
def argparse_config_train():
    ...
    parser.add_argument('--milestones', type=list, default=[20],
                            help='learning rate decay milestones (in epoches number)')
    parser.add_argument('--lambdalr', type=list, default=[0.1,0.006],
    ...
    parser.add_argument('--pretrain_embnet_path', type=str, default=None,
